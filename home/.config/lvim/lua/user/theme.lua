...
M.telescope_theme = function()
    ...
    set_fg_bg("TelescopeBorder", colors.blue, colors.bg)
    set_fg_bg("TelescopePromptBorder", colors.blue, colors.bg)
    ...
    set_fg_bg("TelescopeResultsBorder", colors.blue, colors.bg)
