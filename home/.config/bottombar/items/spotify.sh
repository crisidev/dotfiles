...
GREEN=0xffa6da95
GREY=0xff939ab7
POPUP_BACKGROUND_COLOR=0xff1e1e2e
FONT="SF Pro"
PLUGIN_DIR="$HOME/.config/bottombar/plugins"
SPOTIFY_EVENT="com.spotify.client.PlaybackStateChanged"
POPUP_SCRIPT="bottombar -m --set spotify.anchor popup.drawing=toggle"
...
spotify_anchor=(
    ...
    icon.background.image="app.com.spotify.client"
...
bottombar --add event spotify_change $SPOTIFY_EVENT \
