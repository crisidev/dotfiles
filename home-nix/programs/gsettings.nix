...
}:
{
  home.activation.gsettings = lib.mkAfter ''
    ...
    gsettings set org.gnome.shell.extensions.user-theme name "Tokyonight-Grey-Dark-Storm"
    gsettings set org.gnome.desktop.interface gtk-theme "Tokyonight-Grey-Dark-Storm"
    ...
    gsettings set org.gnome.desktop.wm.preferences theme "Tokyonight-Grey-Dark-Storm"
    ...
    gsettings set org.gnome.desktop.default-applications.terminal exec "$HOME/.bin/kitty"
    ...
    gsettings set org.gnome.shell.extensions.pop-shell tile-enter "['<Super>Backspace']"
    ...
    dconf write /org/gnome/settings-daemon/plugins/media-keys/custom-keybindings/custom13/command "'$HOME/.bin/focus-switch rebalance'"
